		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ManageProductsApp",
									"targetURL": "#manageproducts1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"manageproducts1-display": {
								"semanticObject": "manageproducts1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=manageproducts1",
									"url": sap.ui.require.toUrl("manageproducts1")
								}
							}
						}
					}
